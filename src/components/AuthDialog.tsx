...
interface AuthDialogProps {
  /** Nombre de la red para el título, p. ej. "TikTok" */
  networkName: string
  onClose: () => void
  /** Por ahora solo cerramos; más adelante se usará para enviar autorización */
  onAuthorize?: () => void
}
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        aria-modal="true"
      >
        <div className="p-6 flex flex-col gap-5 max-h-[90vh] overflow-auto">
          <h2
          ...
          <div>
            <p className="font-medium text-sm mb-2" style={{ color: 'var(--copy-primary)' }}>
              Audiense would like to:
            </p>
            <ul className="list-disc list-inside space-y-1 text-sm" style={{ color: 'var(--copy-secondary)' }}>
          ...
          <div className="flex flex-col gap-2 pt-2">
            <Button
              ...
              className="titan-btn-primary w-full justify-center"
            >
              Authorize
            </Button>
            <Button
              onPress={onClose}
              className="titan-btn-tertiary w-full justify-center"
            >
              Cancel
            </Button>
          </div>
